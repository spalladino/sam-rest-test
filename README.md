...
- [SAM API Gateway and DynamoDB example in Java](https://github.com/aws-samples/aws-sam-java-rest) with local testing

# Autogenerated README

_Following is the autogenerated text from the SAM template._
